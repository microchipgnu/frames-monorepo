...
function buildDiscoverSystem(opts: DiscoverEntityOptions): string {
  ...
  lines.push("3. When you have enough evidence, call exactly ONE of:");
  ...
  lines.push("- NEVER fabricate. If you cannot find a primary source, call `no_match` instead of inventing.");
  ...
  lines.push("- Stop AS SOON as you have a decision. Don't over-explore.");
  lines.push("");
  lines.push("## Schema");
  lines.push("");
